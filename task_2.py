# Задача 2. Необходимо создать класс Animal, который имеет атрибуты Name
# (тип животного), Color (его расцветку)
# и Voice (издаваемый звук). Написать функцию, которая возвращает строку
# вида «It says <Voice>.», где <Voice>
